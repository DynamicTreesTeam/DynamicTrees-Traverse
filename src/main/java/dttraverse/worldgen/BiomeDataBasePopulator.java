...
public final class BiomeDataBasePopulator implements IBiomeDataBasePopulator {
    ...
    public void populate(BiomeDataBase biomeDataBase) {
        ...
        // Traverse trees
        final Species fir = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesTraverse.MOD_ID, "fir"));
        final Species autumnBrown = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesTraverse.MOD_ID, "autumn_brown"));
        final Species autumnOrange = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesTraverse.MOD_ID, "autumn_orange"));
        final Species autumnRed = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesTraverse.MOD_ID, "autumn_red"));
        final Species autumnYellow = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesTraverse.MOD_ID, "autumn_yellow"));
        final Species miniJungle = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesTraverse.MOD_ID, "mini_jungle"));
        final Species oakShrub = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesTraverse.MOD_ID, "oak_shrub"));
        ...
        // Desert Shrubland
        this.addSpeciesSelector(biomeDataBase, TraverseWorld.desertShrublandBiome, new BiomePropertySelectors.RandomSpeciesSelector().add(oakShrub, 3).add(8));
